  ...
  const handleCheckRegistration = async (e) => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/devoteeCheck/devotee`,
        {
          method: "POST",
          headers: {
      ...
      if (data.success) {
        ...
        if (data.alreadyBooked) {
          SetBookDetails({
            token: data.booking.Token_Prefix,
            pending_status: data.booking.verify_status,
          });
        }
  ...
  const handleBooking = async () => {
    ...
    try {
      const response = await fetch(
        '${import.meta.env.VITE_API_URL}/api/devoteeCheck/book-seva',
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    <div className="welcome-page-wrapper">
      <div className="welcome-main-container">
        ...
        <div className="welcome-action-grid">
          <div
            className="nav-card primary-card"
          ...
          <div
            className="nav-card secondary-card"
            onClick={() => navigate("/devotee/DevoteeMaster")}
          >
            <div className="nav-card-inner">
              <div className="nav-icon-box">
                <FaUserPlus />
            ...
            <button className="nav-action-button outline">
              New Registration
            </button>
          </div>
        </div>
      ...
      {showCheck && (
        <div className="verify-overlay">
          <div className="verify-modal-content">
            ...
            <p className="modal-subtext">Enter Mobile Number or Email ID.</p>
        ...
        <div className="verify-overlay">
          <div className="verify-modal-content">
            ...
            <div className="devotee-details">
              <p>
                <strong>Name:</strong> {DevoteeDetails.dev_name}
              </p>
              <p>
                <strong>Address:</strong> {DevoteeDetails.dev_address}
              </p>
              <p>
                <strong>Mobile:</strong> {DevoteeDetails.dev_mobile}
              </p>
              {BookingDetails.token && (
                <div>
                  <p>
                    <strong style={{ color: "blue" }}>
                      You have Alredy Registered For the day!!
                    </strong>
                  </p>
                  <p>
                    <strong style={{ fontSize: "20px" }}>Token:</strong>{" "}
                    <span
                      style={{
                        color: "red",
                        fontSize: "20px",
                  ...
                  <p>
                    ...
                    {BookingDetails.pending_status === 1
                      ? "Verified"
                      : "Pending"}
                  </p>
                </div>
                ...
                <div className="seva-grid">
                  ...
                  {sevaList.map((seva) => (
                    <div key={seva.id} className="seva-grid-row">
                      <input
                        type="checkbox"
                        checked={selectedSevas.some(
                          (item) => item.id === seva.id,
                        )}
        ...
        <div className="verify-overlay">
          <div className="verify-modal-content">
            ...
            <div className="token-section">
              ...
              <h2 style={{ fontSize: "32px", color: "red" }}>{Token_Prefix}</h2>
            </div>
