...
const BranchBankingView = () => {
  ...
  const fetchAccounts = async () => {
    setLoading(true);
    try {
      const res = await fetch(`${process.env.base_url}/api/BankDetails`, {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await fetch(
        `${process.env.base_url}/api/BankDetails/${editingData.account_id}`,
        {
          method: "PUT",
          headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const res = await fetch(`${process.env.base_url}/api/BankDetails/${id}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${getToken()}` },
      });
