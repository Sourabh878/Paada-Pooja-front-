...
const BranchDetail = () => {
  ...
  const fetchBranchDetails = async () => {
    try {
      const res = await fetch(
        `${process.env.base_url}/api/TempleBranches/${branchId}`,
        {
  ...
  const handleDeletePhoto = async (photoId) => {
    ...
    try {
      const res = await fetch(
        `${process.env.base_url}/api/TempleBranches/images/${photoId}`,
        {
          method: "DELETE",
          headers: { Authorization: `Bearer ${getToken()}` },
        },
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      for (const file of files) {
        ...
        await fetch(
          `${process.env.base_url}/api/TempleBranches/addImage/${branchId}`,
          {
            method: "POST",
            headers: { Authorization: `Bearer ${getToken()}` },
            body: imageFormData,
