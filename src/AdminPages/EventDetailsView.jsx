...
const EventDetailsView = () => {
  ...
  const fetchInitialData = async () => {
    ...
    try {
      const [evRes, brRes] = await Promise.all([
        fetch(`${import.meta.env.VITE_API_URL}/api/EventMaster`, {
          headers: { Authorization: `Bearer ${getToken()}` },
        }),
        fetch(`${import.meta.env.VITE_API_URL}/api/TempleBranches/all`, {
          headers: { Authorization: `Bearer ${getToken()}` },
        }),
      ]);
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/EventMaster/${editingData.event_id}`,
        {
          method: "PUT",
          headers: {
  ...
  const handleDelete = async (event_id) => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/EventMaster/${event_id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
